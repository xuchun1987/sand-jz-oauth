...
public class MybatisPlusConfig {
    ...
    */
    ...
    @Bean(name = "ds1")
    @ConfigurationProperties(prefix = "oauth.datasource.db1")
    ...
    @Bean(name = "ds2")
    @ConfigurationProperties(prefix = "oauth.datasource.db2")
    ...
    @Bean(name = "ds3")
    @ConfigurationProperties(prefix = "oauth.datasource.db3")
    ...
    public SqlSessionFactory sqlSessionFactory( ResourceLoader resourceLoader) throws Exception {
        ...
        sqlSessionFactory.setTypeAliasesPackage("oauth.entity");
